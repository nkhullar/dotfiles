...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/jhshi/.eclipse/org.eclipse.platform_4.2.0_1473617060/plugins/org.eclim_2.2.5'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/jhshi/.eclipse/org.eclipse.platform_4.2.0_1473617060'
  if has('win32unix')
